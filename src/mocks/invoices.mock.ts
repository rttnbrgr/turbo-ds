...
export const INVOICES_MOCKED_DATA: Invoice[] = [
    {
        ...
        notes: "Thank you for choosing Madison Handyman for your home maintenance needs.",
        items: [
            {
    ...
    },
    {
        ...
        notes: "This section will only populate if general notes do exist. This is an example of a pretty long note that can span multiple lines.",
        items: [
            {
                description: "Mowing Full Lawn",
                details:
